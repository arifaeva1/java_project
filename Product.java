...
public abstract class Product implements IQuantity {
	...
	protected int availableQuantity;                                                    //how much available
	...
	public void addQuantity(int amount){
		if(amount>0){
			...
			System.out.println("add new Quantity : "+amount);
			...
			System.out.println("it cant be added");
		}
	...
	public void sellQuantity(int amount){
		if(amount>0 && amount<=availableQuantity){
			...
			System.out.println("it cant be sold");
		}
	}
}
